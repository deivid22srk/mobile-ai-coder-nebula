// Compact SVG icon set — Lucide-style stroke icons.
// Using inline SVGs (no extra dep) so we can color via currentColor.
...
const paths: Record<IconName, JSX.Element> = {
  ...
  sparkles: (<><path d="M12 3l1.9 5.5L19 10.4l-5.1 1.9L12 18l-1.9-5.7L5 10.4l5.1-1.9L12 3z" /><path d="M19 3l.6 1.7L21 5.3l-1.4.6L19 8l-.6-2.1L17 5.3l1.4-.6L19 3z" /><path d="M5 17l.6 1.7L7 19.3l-1.4.6L5 21l-.6-1.4L3 19.3l1.4-.6L5 17z" /></>),
  user: (<><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" /><circle cx="12" cy="7" r="4" /></>),
  bot: (<><rect x="3" y="11" width="18" height="10" rx="2" /><circle cx="12" cy="5" r="2" /><path d="M12 7v4" /><line x1="8" y1="16" x2="8" y2="16" /><line x1="16" y1="16" x2="16" y2="16" /></>),
  wrench: (<><path d="M14.7 6.3a4 4 0 0 0-5.4 5.4l-6 6a2 2 0 0 0 2.8 2.8l6-6a4 4 0 0 0 5.4-5.4l-3 3-2-2 3-3z" /></>),
